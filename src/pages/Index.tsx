        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center gap-2 sm:gap-3">
              <Calendar className="w-6 h-6 sm:w-8 sm:h-8 text-purple-400 flex-shrink-0" />
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-300 dark:text-gray-400">December 2025</p>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
              <ChristmasGiftButton />
              <LoginArea className="flex-1 sm:flex-initial sm:max-w-60" />
            </div>
          </div>
        </div>
      </header>
